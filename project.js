...
var mygifs = {
    ...
    myArray: ["sceince", "music", "star wars", "coding", "turtles","baby Yoda"],
    userInput: "",
    ...
    clickHandler: function() {
        ...
        $(document).on("click", ".myNewbuttons", function() {
            ...
            mygifs.doApiStuff(gifSelected);
        })
        $(document).on("click", ".myNewGifs", function() {
            var state = $(this).attr("data-state");
            var gifClicked = this;
            mygifs.manipulateGifs(state, gifClicked);
        })
    },
